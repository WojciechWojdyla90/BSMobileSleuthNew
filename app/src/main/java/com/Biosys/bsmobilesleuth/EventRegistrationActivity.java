...
public class EventRegistrationActivity extends OrmLiteBaseActivity<DatabaseHelper> implements OnItemSelectedListener{
	...
	private void sendEvent(){
		...
		new AsyncSendEvent().execute("",Integer.toString(first.getChecktype()),Integer.toString(first.getUserId()),
			...
			Toast.makeText(context, "Wszystkie zdarzenia wysłano", Toast.LENGTH_LONG).show();
		}
	}
	...
	private class AsyncSendEvent extends AsyncTask<String, JSONObject, Boolean> {
        ...
        protected void onPreExecute() {
            //super.onPreExecute();
            		...
            		progDailog.setMessage("Trwa wysyłanie zdarzeń ...");
            		progDailog.show();
            	}
        ...
        protected void onPostExecute(Boolean result) {
        	...
        	Toast.makeText(context, "Poprawnie wysłano zdarzenie", Toast.LENGTH_LONG).show();
		}
